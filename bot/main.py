...
def main():
    ...
    openai_config = {
        ...
        'assistant_prompt': os.environ.get('BOT_GPT_PROMPT', 'You are a helpful assistant.'),
        ...
        'vision_prompt': os.environ.get('VISION_PROMPT', 'Describe this image'),
    ...
    telegram_config = {
        ...
        'token_price': float(os.environ.get('TOKEN_PRICE_GPT_3.5_TURBO', 0.002)),
    ...
    telegram_bot = ChatGPTTelegramBot(config=telegram_config, openai_helper=openai_helper)
    telegram_bot.run()
